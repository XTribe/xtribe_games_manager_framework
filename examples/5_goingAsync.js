...
*/
var options = {
	port : 9005, 			    // Your manager will be listening on this port E.g.: http://localhost:9005 (or http://yourServerAddress:yourPort)				
	...
	monitor : {							        
		enabled : true 			// Enable/disable Monitor, it will be available by default on this link: http://localhost:9005/monitor (or http://yourServerAddress:yourPort/monitor)
	}               
};
